...
try:
    ...
    def load_settings() -> Settings:
        ...
        return Settings(
            ...
            POSTGRES_URL=os.getenv("POSTGRES_URL", "postgresql://user:password@localhost:5432/hungry_spider"),
            ...
            MAX_CONTENT_CHARS=_parse_int(os.getenv("MAX_CONTENT_CHARS"), 12000),
